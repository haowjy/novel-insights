...
from novelinsights.wikigen_fiction.prompts.models import character_schema
...
class CoreSummaryAgent(BaseAgent):
    ...
    def generate(self, content:ReadChapterResponse, prev_json: dict = None) -> CoreSummaryResponse:
        ...
        """
        resp_str = self.llm.generate(self.prompt(content, prev_json))
