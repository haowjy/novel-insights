...
def excerpt_template(excerpt: TocNode, story_so_far: str = None, prev_chap_context: str = None) -> str:
    return template(excerpt.title, excerpt.content, story_so_far, prev_chap_context)
...
def template(title:str, content:str, story_so_far: str = None, prev_chap_context: str = None) -> str:
    ...
    Args:
        ...
        story_so_far (str, optional): _description_. Defaults to None.
        prev_chap_context (str, optional): _description_. Defaults to None.
