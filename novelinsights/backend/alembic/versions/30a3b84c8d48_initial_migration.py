...
Revision ID: 30a3b84c8d48
Revises: 
Create Date: 2025-02-08 18:17:53.801253
...
def upgrade() -> None:
    ...
    sa.Enum('CHARACTER', 'ORGANIZATION', 'LOCATION', 'ITEM', 'CONCEPT', 'CULTURE', 'EVENT', 'TIME_PERIOD', 'ARC', 'THEME', 'OTHER', name='nodetype').create(op.get_bind())
    ...
    sa.Column('type', postgresql.ENUM('CHARACTER', 'ORGANIZATION', 'LOCATION', 'ITEM', 'CONCEPT', 'CULTURE', 'EVENT', 'TIME_PERIOD', 'ARC', 'THEME', 'OTHER', name='nodetype', create_type=False), nullable=False),
    ...
    sa.Column('node_type', postgresql.ENUM('CHARACTER', 'ORGANIZATION', 'LOCATION', 'ITEM', 'CONCEPT', 'CULTURE', 'EVENT', 'TIME_PERIOD', 'ARC', 'THEME', 'OTHER', name='nodetype', create_type=False), nullable=False),
...
def downgrade() -> None:
    ...
    sa.Enum('CHARACTER', 'ORGANIZATION', 'LOCATION', 'ITEM', 'CONCEPT', 'CULTURE', 'EVENT', 'TIME_PERIOD', 'ARC', 'THEME', 'OTHER', name='nodetype').drop(op.get_bind())
