...
def upgrade() -> None:
    ...
    sa.Enum('TEMPLATE', name='prompttype').create(op.get_bind())
    ...
    sa.Enum('OUTBOUND', 'INBOUND', 'BIDIRECTIONAL', name='relationshipdirection').create(op.get_bind())
    sa.Enum('ACTIVE', 'DORMANT', 'BROKEN', 'DECEASED', 'HISTORICAL', 'UNKNOWN', name='relationshipstatus').create(op.get_bind())
    ...
    sa.Column('core_type', postgresql.ENUM('CHARACTER', 'ORGANIZATION', 'LOCATION', 'ITEM', 'CONCEPT', 'CULTURE', 'EVENT', 'TIME_PERIOD', 'ARC', 'THEME', 'OTHER', name='corenodetype', create_type=False), nullable=False),
    ...
    op.create_index(op.f('ix_node_core_type'), 'node', ['core_type'], unique=False)
    op.create_index(op.f('ix_node_created_at'), 'node', ['created_at'], unique=False)
    op.create_index(op.f('ix_node_creation_source'), 'node', ['creation_source'], unique=False)
    op.create_index(op.f('ix_node_name'), 'node', ['name'], unique=False)
    op.create_index(op.f('ix_node_optional_type'), 'node', ['optional_type'], unique=False)
    op.create_index('ix_node_ts_vector', 'node', ['ts_vector'], unique=False, postgresql_using='gin')
    ...
    sa.Column('direction', postgresql.ENUM('OUTBOUND', 'INBOUND', 'BIDIRECTIONAL', name='relationshipdirection', create_type=False), nullable=False),
    ...
    op.create_index(op.f('ix_node_relationship_created_at'), 'node_relationship', ['created_at'], unique=False)
    op.create_index(op.f('ix_node_relationship_creation_source'), 'node_relationship', ['creation_source'], unique=False)
    op.create_index(op.f('ix_node_relationship_current_status'), 'node_relationship', ['current_status'], unique=False)
    op.create_index(op.f('ix_node_relationship_direction'), 'node_relationship', ['direction'], unique=False)
    ...
    op.create_index(op.f('ix_node_state_created_at'), 'node_state', ['created_at'], unique=False)
    op.create_index(op.f('ix_node_state_creation_source'), 'node_state', ['creation_source'], unique=False)
    ...
    sa.Column('prompt_type', postgresql.ENUM('TEMPLATE', name='prompttype', create_type=False), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_node_relationship_direction'), table_name='node_relationship')
    op.drop_index(op.f('ix_node_relationship_current_status'), table_name='node_relationship')
    ...
    op.drop_index('ix_node_ts_vector', table_name='node', postgresql_using='gin')
    op.drop_index(op.f('ix_node_optional_type'), table_name='node')
    op.drop_index(op.f('ix_node_name'), table_name='node')
    op.drop_index(op.f('ix_node_creation_source'), table_name='node')
    op.drop_index(op.f('ix_node_created_at'), table_name='node')
    op.drop_index(op.f('ix_node_core_type'), table_name='node')
    op.drop_table('node')
    ...
    sa.Enum('ACTIVE', 'DORMANT', 'BROKEN', 'DECEASED', 'HISTORICAL', 'UNKNOWN', name='relationshipstatus').drop(op.get_bind())
    sa.Enum('OUTBOUND', 'INBOUND', 'BIDIRECTIONAL', name='relationshipdirection').drop(op.get_bind())
    ...
    sa.Enum('TEMPLATE', name='prompttype').drop(op.get_bind())
    # ### end Alembic commands ###
